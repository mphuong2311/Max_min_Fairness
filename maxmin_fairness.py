...
def max_min_fairness(speeds):
    ...
    fair_speed = max_speed * len(speeds)
    return fair_speed
...
while traci.simulation.getMinExpectedNumber() > 0:
    ...
    for i in range(0, len(vehicles)):
        ...
        for k in range(0, len(trafficlights)):
            ...
            # REF: https://sumo.dlr.de/docs/TraCI/Traffic_Lights_Value_Retrieval.html#structure_of_compound_object_controlled_links
            # REF: https://sumo.dlr.de/pydoc/traci._trafficlight.html#TrafficLightDomain-setRedYellowGreenState
        ...
        if vehicles[i] == 'veh2':
            ...
            traci.vehicle.setSpeed('veh2', fair_speed)
